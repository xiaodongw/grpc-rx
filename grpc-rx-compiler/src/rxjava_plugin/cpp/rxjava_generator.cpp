    ...
    if (flavor == ProtoFlavor::NANO) {
      ...
      p->Print(
          *vars,
          ...
          "        .setFullMethodName(generateFullMethodName(\"$Package$$service_name$\", \"$method_name$\"))\n"
      ...
      p->Print(
          *vars,
          ...
          "        .setType($MethodType$.$method_type$)\n"
          "        .setFullMethodName(generateFullMethodName(\"$Package$$service_name$\", \"$method_name$\"))\n"
          "        .setRequestMarshaller($ProtoUtils$.marshaller($input_type$.getDefaultInstance()))\n"
          "        .setResponseMarshaller($ProtoUtils$.marshaller($output_type$.getDefaultInstance()))\n"
          "        .build();");
    }
  }
  p->Print("\n");
